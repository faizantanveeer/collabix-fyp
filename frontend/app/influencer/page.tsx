		...
		const fetchInfluencers = async () => {
			try {
				const response = await fetch(
					'http://localhost:5000/influencers'
				);
				if (!response.ok) {
	...
	return (
		<>
			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 mt-16">
				<h1 className="text-4xl  text-center mb-6 text-gray-800 dark:text-white">
					Top Influencers
				</h1>

				{/* Search & Filter Section */}
				<div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
					<div className="relative rounded w-full sm:w-1/2 focus-within:ring-0 focus-within:outline-none">
						<Search
						...
						<Input
							...
							className="pl-10 !outline-none !ring-transparent "
							value={search}
