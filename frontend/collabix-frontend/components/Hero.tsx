...
export default function Hero() {
  return (
    <section className="relative flex items-center justify-center h-screen bg-[#0a0e17] text-white">
    ...
    <div className="relative z-10 text-center p-8 max-w-5xl">
      ...
      {/* <div
        className={`flex justify-center  border border-yellow-400 align-center mt-12 transition-all duration-500 ease-in-out transform ${
          showScrollEffect
